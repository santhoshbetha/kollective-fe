...
export const generateMappings = (data) => {
  const result = {};
  ...
  for (const [_native, [unified, shortcode]] of Object.entries(tweaks)) {
    const stripped = stripcodes(unified);

    result[_native] = { unified: stripped, shortcode };
  }
