  ...
  return (
    <div 
      className={`
        ...
        ${post.filtered ? 'opacity-60 grayscale' : ''}
      `}
    >
      ...
      <div className="flex gap-3">
        ...
        <div className="flex-shrink-0 w-10 h-10 bg-gray-200 rounded-full overflow-hidden">
           <img src={post.account.avatar} alt="" className="w-full h-full object-cover" />
        </div>
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* Content */}
          <div className={`mt-1 text-[15px] leading-normal text-gray-800 break-words ${post.filtered ? 'blur-sm select-none' : ''}`}>
             {post.filtered ? "This content matches your filters" : post.content}
          </div>
