const Timeline = ({ type, endpoint }) => {
  ...
  return (
    <div>
      ...
      {data.pages.map(page => page.items.map(s => <Post post={s} />))}
    </div>
  );
};
...
export const Timeline2 = ({ type, endpoint, params }) => {
  ...
  const rowVirtualizer = useVirtualizer({
    ...
    estimateSize: () => 150, // Average height of a post card
...
//============================================================
// /Scroll Restoration
// src/features/posts/components/Timeline.jsx
import { useScrollStore } from '../store/useScrollStore';

export const Timeline3 = ({ type, endpoint, params }) => {
